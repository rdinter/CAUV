...
- Current projection for average CAUV value in 2020 is `r dollar(ohio_soils_all$expected[ohio_soils_all$year == 2020], accuracy = 5)` which would represent a change of `r percent((ohio_soils_all$expected[ohio_soils_all$year == 2020] - ohio_soils_all$expected[ohio_soils_all$year == 2019]) / ohio_soils_all$expected[ohio_soils_all$year == 2019], accuracy = 1)` from the previous tax year.
