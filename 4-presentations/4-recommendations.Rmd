...
- ODT synthesizes each OSU crop budget to then calculate the Olympic average of each item:
...
![](offline/corn-osu-budget-2019-alt.png)
...
read_rds("../3-proj/recommendations/ohio_nonland_alt.rds") %>% 
  ...
  select(Year = year, "Avg CAUV" = official_avg, "Alt Avg CAUV" = avg_cauv, everything()) %>% 
  knitr::kable() %>% 
  kable_styling(latex_options = "scale_down")
```
