...
ohio <- read_rds(paste0(future, "/ohio.rds"))
...
ohio_low <- read_rds(paste0(future, "/ohio_low.rds"))
ohio_high <- read_rds(paste0(future, "/ohio_high.rds"))
ohio_exp <- read_rds(paste0(future, "/ohio_exp.rds"))
ohio_soils <- read_rds(paste0(future, "/ohio_soils.rds"))
ohio_soils_low <- read_rds(paste0(future, "/ohio_soils_low.rds"))
ohio_soils_high <- read_rds(paste0(future, "/ohio_soils_high.rds"))
ohio_soils_exp <- read_rds(paste0(future, "/ohio_soils_exp.rds"))
